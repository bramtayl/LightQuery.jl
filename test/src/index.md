...
julia> @> by_date |>
        ...
        Peek
Showing at most 4 rows
|     `date` | `TMAX` | `TMIN` | `PRCP` | `SNOW` | `SNWD` |  `WT16` |
| ----------:| ------:| ------:| ------:| ------:| ------:| -------:|
| 1949-01-01 |    289 |    217 |      0 |      0 |      0 | missing |
| 1949-01-02 |    289 |    228 |     30 |      0 |      0 | missing |
| 1949-01-03 |    283 |    222 |      0 |      0 |      0 | missing |
| 1949-01-04 |    283 |    233 |      0 |      0 |      0 |       1 |
```
